...
export class Game {
     ...
     */
    get_px() {
        const ret = wasm.game_get_px(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_py() {
        const ret = wasm.game_get_py(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_pz() {
        const ret = wasm.game_get_pz(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} w
     ...
     */
    get_yaw() {
        const ret = wasm.game_get_yaw(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} dx
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('peakstrife_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
